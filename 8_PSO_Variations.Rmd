...
reactable(
  ...
  columns = list(
    ...
    const_break_mean = colDef(format = colFormat(digits=4), width=145),
    best_fit_q1 = colDef(format = colFormat(digits=4), width=100),
    best_fit_q3 = colDef(format = colFormat(digits=4), width=100),
    best_fit_mean = colDef(format = colFormat(digits=4), width=110),
    best_fit_median = colDef(format = colFormat(digits=4), width=125)
  ),
  compact = T,
  rownames = F
) %>% 
