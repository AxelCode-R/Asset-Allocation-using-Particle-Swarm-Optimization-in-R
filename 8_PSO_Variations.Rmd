...
$$
  \text{score} = 2 \cdot \text{q1_fit_rnk} + \text{mean_fit_rnk} + \text{q3_fit_rnk} + 0.25 \cdot \text{q1_const_break_rnk} + 0.25 \cdot \text{mean_const_break_rnk} + 0.5 \cdot \text{q3_const_break_rnk} + 2 \cdot \text{mean_runtime_rnk}
$$
