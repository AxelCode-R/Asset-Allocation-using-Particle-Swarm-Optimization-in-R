...
This thesis has been concerned with analyzing and testing the PSO. The focus was on financial mathematical optimization problems in the area of quantitative portfolio management. In paxis it is relevant to solve this kind of problems with the same complexity as in real life, which is made possible by the PSO. It could be shown that even complex optimization problems can be solved in a stable way. 
