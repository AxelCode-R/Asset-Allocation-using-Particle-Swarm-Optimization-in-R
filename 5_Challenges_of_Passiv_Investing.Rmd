...
```{r MVPex5, echo = knitr::is_html_output(), class.source="code_fold_it_collapsed", warning=F, message=F, fig.cap = "Optimal MVP for each lambda and interpolated efficient frontier"}
