...
\begin{align*}
 ...
 \end{bmatrix}\\
  &=\textstyle\sum
\end{align*}
and can be estimated in R using the basis function `cov()` and historical data. The function `cov_()` in \@ref(covfun) can be used to calculate the covariance using the geometric mean to estimate the expected returns.
