...
and can be estimated in R using the basis function `cov()` and historical data. The function `cov_()` explained in section \@ref(covfun) can be used to calculate the covariance using the geometric mean to estimate the expected returns.
