...
```{r pso7, echo = knitr::is_html_output(), class.source="code_fold_it_collapsed", fig.cap = "Comparison of the MVP's generated with solve.QP() and the PSO. The gray lines show the difference of the solutions of both approaches for each $\\lambda$ (lambda)."}
set.seed(0)
