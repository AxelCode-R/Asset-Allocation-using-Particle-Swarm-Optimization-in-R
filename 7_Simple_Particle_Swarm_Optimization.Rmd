...
$$
  ...
  X^{i+1} = X^i + V^{i+1}
$$
with positions $X \in R^{N,D}$, velocity's $V \in R^{N,D}$, best own positions $P \in R^{N,D}$ and the global best position $p_g \in R^{N}$. The parameters $w$, $c_1$, $c_2$, $r_1$ and $r_2$ are stile scalars. but 
