...
A continuous solution for a portfolio is not sufficient for the practice, because only integer amounts of assets can be bought. It's even worse if lot sizes are needed, because these can only be bought in minimum denomination of e.g. ten thousand. Lot sizes are often used in fixed income products.
...
# print("solve.QP")
# res_qp_discrete_fit
# sum(res_qp_discrete_sum_wgt)
# 
# print("PSO")
# res_pso_fit
# sum(pso_res$solution)
# 
# print("PSO 2")
# res_pso_2_fit
# sum(pso_2_res$solution)

reactable(data.frame(
  "type" = c("solve.QP discrete", "PSO", "PSO with solve.QP init res"),
  "fitnes" = c(res_qp_discrete_fit, res_pso_fit, res_pso_2_fit),
