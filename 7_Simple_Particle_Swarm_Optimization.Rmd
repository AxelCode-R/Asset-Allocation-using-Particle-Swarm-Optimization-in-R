...
for(i in 1:length(unique(trace_data$iter)) ){
  ...
  file.copy(from = "docs/p.png", to = paste0("gifs/pso_2dim_v2/gif_2dim_", if(i<10){paste0("0",i)}else{i},".png"))
}

```
```{=latex}
\begin{center}
\animategraphics[loop, width=10cm]{10}{./gifs/pso_2dim_v2/gif_2dim_}{1}{40}
\begin{figure}[!h]
