...
This section provides insights into the effects of diversification and the use of `solve.QP`, by creating ten diffrent efficient frontiers from a pool of ten assets. Each efficient frontier $i$ consists of $N_i = i$ assets and is created by adding the next smallest variance first. After loading returns for ten of the biggest equitys in the US market, the variance is calculated to arrange all columns ascending, like shown in the code bellow:
