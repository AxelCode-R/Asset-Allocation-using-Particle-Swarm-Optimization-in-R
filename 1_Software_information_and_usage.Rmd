...
### javascript files
The javascript files are located in the `www/` folder and are used for the HTML version of this thesis to make code blocks expandable. This allows the reader to inspect the code used and to follow analyses in detail.
