...
![Backtest Process: visualized as a flowchart](img/Chapter9_PSO_Process6.jpg)
...
p_0tc %>% html_save(., vwidth=700, vheight=350, expand=c(-30,20,-15,-20))
```
...
p_10tc %>% html_save(., vwidth=700, vheight=350, expand=c(-30,20,-15,-20))
```
...
p_20tc %>% html_save(., vwidth=700, vheight=350, expand=c(-30,20,-15,-20))
```
...
p_30tc %>% html_save(., vwidth=700, vheight=350, expand=c(-30,20,-15,-20))
```
...
plotly_line_chart_xts(cbind.xts(p_0tc_diff, p_10tc_diff, p_20tc_diff, p_30tc_diff)) %>% 
  html_save(., vwidth=700, vheight=350, expand=c(-30,20,-15,-20))
```
