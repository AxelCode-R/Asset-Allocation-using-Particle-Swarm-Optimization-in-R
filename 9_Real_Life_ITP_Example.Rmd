...
```{r, fig.cap="Backtest Process: visualized as a flowchart", eval=F, include=knitr::is_html_output()}
knitr::include_graphics("img/Chapter9_PSO_Process7.jpg")
```
```{=latex}
\includesvg{img/Chapter9_PSO_Process2.drawio}
