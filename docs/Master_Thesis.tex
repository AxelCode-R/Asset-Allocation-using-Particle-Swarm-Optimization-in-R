...
\NormalTok{)\{}
  ...
  \CommentTok{\# use default control values if not set}
\NormalTok{  control\_ }\OtherTok{=} \FunctionTok{list}\NormalTok{(}
    \AttributeTok{s =} \DecValTok{10}\NormalTok{, }\CommentTok{\# swarm size}
    \AttributeTok{c.p =} \FloatTok{0.5}\NormalTok{, }\CommentTok{\# inherit best}
    \AttributeTok{c.g =} \FloatTok{0.5}\NormalTok{, }\CommentTok{\# global best}
    \AttributeTok{maxiter =} \DecValTok{200}\NormalTok{, }\CommentTok{\# iterations}
    \AttributeTok{w0 =} \FloatTok{1.2}\NormalTok{, }\CommentTok{\# starting inertia weight}
    \AttributeTok{wN =} \DecValTok{0}\NormalTok{, }\CommentTok{\# ending inertia weight}
    \AttributeTok{save\_traces =}\NormalTok{ F, }\CommentTok{\# save more information}
    \AttributeTok{fn\_stretching =}\NormalTok{ F}
\NormalTok{  )}
\NormalTok{  control }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(control, control\_[}\SpecialCharTok{!}\FunctionTok{names}\NormalTok{(control\_) }\SpecialCharTok{\%in\%} \FunctionTok{names}\NormalTok{(control)])}
  
\NormalTok{  fn1 }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(pos)\{}\FunctionTok{fn}\NormalTok{(pos)\}}
    
  \CommentTok{\# init data{-}structure}
\NormalTok{  X }\OtherTok{\textless{}{-}} \FunctionTok{mrunif}\NormalTok{(}
    \AttributeTok{nr =} \FunctionTok{length}\NormalTok{(par), }\AttributeTok{nc=}\NormalTok{control}\SpecialCharTok{$}\NormalTok{s, }\AttributeTok{lower=}\NormalTok{lower, }\AttributeTok{upper=}\NormalTok{upper}
\NormalTok{  )}
  \ControlFlowTok{if}\NormalTok{(}\FunctionTok{all}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(par)))\{}
\NormalTok{    X[, }\DecValTok{1}\NormalTok{] }\OtherTok{\textless{}{-}}\NormalTok{ par}
\NormalTok{  \}}
\NormalTok{  X\_fit }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(X, }\DecValTok{2}\NormalTok{, fn1)}
\NormalTok{  V }\OtherTok{\textless{}{-}} \FunctionTok{mrunif}\NormalTok{(}
    \AttributeTok{nr =} \FunctionTok{length}\NormalTok{(par), }\AttributeTok{nc=}\NormalTok{control}\SpecialCharTok{$}\NormalTok{s,}
    \AttributeTok{lower=}\SpecialCharTok{{-}}\NormalTok{(upper}\SpecialCharTok{{-}}\NormalTok{lower), }\AttributeTok{upper=}\NormalTok{(upper}\SpecialCharTok{{-}}\NormalTok{lower)}
\NormalTok{  )}\SpecialCharTok{/}\DecValTok{4}
...
\NormalTok{    X }\OtherTok{\textless{}{-}}\NormalTok{ X }\SpecialCharTok{+}\NormalTok{ V}
    ...
    \CommentTok{\# set velocity to zeros if not in valid space}
\NormalTok{    V[X }\SpecialCharTok{\textgreater{}}\NormalTok{ upper] }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\NormalTok{V[X }\SpecialCharTok{\textgreater{}}\NormalTok{ upper]}
\NormalTok{    V[X }\SpecialCharTok{\textless{}}\NormalTok{ lower] }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\NormalTok{V[X }\SpecialCharTok{\textless{}}\NormalTok{ lower]}
...
\NormalTok{    \}}
    ...
    \ControlFlowTok{if}\NormalTok{(control}\SpecialCharTok{$}\NormalTok{fn\_stretching)\{}
\NormalTok{      fn1 }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(pos)\{}
\NormalTok{        res }\OtherTok{\textless{}{-}} \FunctionTok{fn}\NormalTok{(pos)}
\NormalTok{        G }\OtherTok{\textless{}{-}}\NormalTok{ res }\SpecialCharTok{+} \FloatTok{1.5} \SpecialCharTok{*} \FunctionTok{sqrt}\NormalTok{(}\FunctionTok{sum}\NormalTok{((pos }\SpecialCharTok{{-}}\NormalTok{ p\_g)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)) }\SpecialCharTok{*}\NormalTok{ (}\FunctionTok{sign}\NormalTok{(res }\SpecialCharTok{{-}}\NormalTok{ p\_g\_fit) }\SpecialCharTok{+} \DecValTok{1}\NormalTok{)}
\NormalTok{        H }\OtherTok{\textless{}{-}}\NormalTok{ G }\SpecialCharTok{+} \FloatTok{0.5} \SpecialCharTok{*}\NormalTok{ (}\FunctionTok{sign}\NormalTok{(res }\SpecialCharTok{{-}}\NormalTok{ p\_g\_fit) }\SpecialCharTok{+} \DecValTok{1}\NormalTok{)}\SpecialCharTok{/}\NormalTok{(}\FunctionTok{tanh}\NormalTok{(}\FloatTok{0.1} \SpecialCharTok{*}\NormalTok{ (G }\SpecialCharTok{{-}}\NormalTok{ p\_g\_fit)))}
        \FunctionTok{return}\NormalTok{(H)}
\NormalTok{      \}}
\NormalTok{    \}}

    \ControlFlowTok{if}\NormalTok{(control}\SpecialCharTok{$}\NormalTok{save\_traces)\{}
\NormalTok{      trace\_data }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(trace\_data, }\FunctionTok{data.frame}\NormalTok{(}\StringTok{"iter"}\OtherTok{=}\NormalTok{i, }\StringTok{"mean\_fit"} \OtherTok{=} \FunctionTok{mean}\NormalTok{(P\_fit), }\StringTok{"best\_fit"} \OtherTok{=}\NormalTok{ p\_g\_fit, }\FunctionTok{t}\NormalTok{(X)))}
\NormalTok{    \}}
\NormalTok{  \}}

\NormalTok{  res }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}
    \StringTok{"solution"} \OtherTok{=}\NormalTok{ p\_g,}
    \StringTok{"fitness"} \OtherTok{=}\NormalTok{ p\_g\_fit}
\NormalTok{  )}
  \ControlFlowTok{if}\NormalTok{(control}\SpecialCharTok{$}\NormalTok{save\_traces)\{}
\NormalTok{    res}\SpecialCharTok{$}\NormalTok{trace\_data }\OtherTok{\textless{}{-}}\NormalTok{ trace\_data}
\NormalTok{  \}}
  \FunctionTok{return}\NormalTok{(res)}
\NormalTok{\}}
...
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{0}\NormalTok{)}
\NormalTok{res\_pso\_fns\_time }\OtherTok{\textless{}{-}} \FunctionTok{system.time}\NormalTok{(\{}
\NormalTok{  res\_pso\_fns }\OtherTok{\textless{}{-}} \FunctionTok{pso}\NormalTok{(}
\NormalTok{    par }\OtherTok{\textless{}{-}} \FunctionTok{rep}\NormalTok{(}\ConstantTok{NA}\NormalTok{, }\DecValTok{2}\NormalTok{),}
\NormalTok{    fn }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(pos)\{}
      \SpecialCharTok{{-}}\DecValTok{20} \SpecialCharTok{*} \FunctionTok{exp}\NormalTok{(}\SpecialCharTok{{-}}\FloatTok{0.2} \SpecialCharTok{*} \FunctionTok{sqrt}\NormalTok{(}\FloatTok{0.5} \SpecialCharTok{*}\NormalTok{((pos[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{)}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{+}\NormalTok{ (pos[}\DecValTok{2}\NormalTok{]}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{))) }\SpecialCharTok{{-}} 
      \FunctionTok{exp}\NormalTok{(}\FloatTok{0.5}\SpecialCharTok{*}\NormalTok{(}\FunctionTok{cos}\NormalTok{(}\DecValTok{2}\SpecialCharTok{*}\NormalTok{pi}\SpecialCharTok{*}\NormalTok{pos[}\DecValTok{1}\NormalTok{]) }\SpecialCharTok{+} \FunctionTok{cos}\NormalTok{(}\DecValTok{2}\SpecialCharTok{*}\NormalTok{pi}\SpecialCharTok{*}\NormalTok{pos[}\DecValTok{2}\NormalTok{]))) }\SpecialCharTok{+} 
...
\NormalTok{    upper }\OtherTok{\textless{}{-}} \DecValTok{10}\NormalTok{,}
    \AttributeTok{control =} \FunctionTok{list}\NormalTok{(}
      ...
      \AttributeTok{wN =} \DecValTok{0}\NormalTok{, }\CommentTok{\# ending inertia weight}
      \AttributeTok{save\_traces =}\NormalTok{ T, }\CommentTok{\# save more information}
      \AttributeTok{fn\_stretching =}\NormalTok{ T}
\NormalTok{    )}
\NormalTok{  )}
\NormalTok{\})}

\NormalTok{df }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(}
    \StringTok{"type"} \OtherTok{=} \StringTok{"PSO"}\NormalTok{, res\_pso}\SpecialCharTok{$}\NormalTok{trace\_data }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(iter, mean\_fit, best\_fit)}
\NormalTok{  ),}
  \FunctionTok{data.frame}\NormalTok{(}
    \StringTok{"type"} \OtherTok{=} \StringTok{"PSO{-}fnS"}\NormalTok{, res\_pso\_fns}\SpecialCharTok{$}\NormalTok{trace\_data }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(iter, mean\_fit, best\_fit)}
\NormalTok{  )}
\NormalTok{)}
...
\includegraphics{Master_Thesis_files/figure-latex/unnamed-chunk-4-1.pdf}
...
\NormalTok{  const[mat}\SpecialCharTok{$}\NormalTok{meq] }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\FunctionTok{max}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FunctionTok{abs}\NormalTok{(const[mat}\SpecialCharTok{$}\NormalTok{meq]}\SpecialCharTok{+}\FloatTok{0.01}\NormalTok{)}\SpecialCharTok{{-}}\FloatTok{0.01}\NormalTok{)}
