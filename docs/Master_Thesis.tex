...
\item
  prices\_type = ``close'': Type of prices to gather (e.g ``open'', ``high'', ``low'', ``close'', ``adjusted'')
\item
  return\_type = ``adjusted'': Type of returns to gather (e.g ``open'', ``high'', ``low'', ``close'', ``adjusted'')
\item
  print = F: Should the function print the return of \texttt{getSymbols}
\end{itemize}
...
\hypertarget{solving-mvp-with-solve.qp}{%
\subsection{\texorpdfstring{Solving MVP with \texttt{solve.QP}}{Solving MVP with solve.QP}}\label{solving-mvp-with-solve.qp}}
