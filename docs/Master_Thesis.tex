...
\NormalTok{V }\OtherTok{\textless{}{-}} \FunctionTok{mrunif}\NormalTok{(}\AttributeTok{nr =} \FunctionTok{length}\NormalTok{(par), }\AttributeTok{nc=}\NormalTok{control}\SpecialCharTok{$}\NormalTok{s, }\AttributeTok{lower=}\SpecialCharTok{{-}}\NormalTok{(upper}\SpecialCharTok{{-}}\NormalTok{lower), }\AttributeTok{upper=}\NormalTok{(upper}\SpecialCharTok{{-}}\NormalTok{lower))}\SpecialCharTok{/}\DecValTok{4}
\end{Highlighting}
\end{Shaded}
...
The particle with the best fitness and its position after hundred iterations is:
...
\begin{verbatim}
## [1] -0.000000007943707  0.000134760618526
\end{verbatim}

\begin{verbatim}
## [1] "fittness: 0.000134768562232869"
\end{verbatim}
