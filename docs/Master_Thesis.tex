...
\begin{align*}
 ...
 \mu
\end{align*}
and \(\mu_i\) can be estimated in R with the base-function \texttt{mean()} of historical data.
...
\begin{align*}
 ...
 \end{bmatrix}\\
  &=\sum
\end{align*}
and can be estimated in R with the base-function \texttt{cov()} of historical data.
