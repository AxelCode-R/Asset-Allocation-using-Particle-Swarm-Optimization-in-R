...
It can be seen, that each asset added results in a minimum variance portfolio with smaller standard deviation. Nonetheless that it starter with the asset that has the smallest standard deviation of 0.0001822. This is the effect of diversification mentioned by Markowitz.
