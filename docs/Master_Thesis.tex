...
other attached packages:
 [1] alphavantager_0.1.2 ggpubr_0.5.0        metR_0.12.0        
 [4] gganimate_1.0.7     quantmod_0.4.20     TTR_0.24.3         
 [7] reactable_0.3.0     bookdown_0.31       webshot2_0.1.0     
[10] corrr_0.4.3         data.table_1.14.2   pso_1.0.3          
[13] plotly_4.10.0       matrixcalc_1.0-5    Matrix_1.5-3       
[16] quadprog_1.5-8      xts_0.12.1          zoo_1.8-9          
[19] rvest_1.0.2         forcats_0.5.1       stringr_1.4.0      
[22] purrr_0.3.4         tidyr_1.2.0         tibble_3.1.8       
[25] ggplot2_3.4.0       tidyverse_1.3.2     readr_2.1.2        
[28] dplyr_1.0.9         lubridate_1.8.0    
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/unnamed-chunk-2-1.png}
\caption{\label{fig:unnamed-chunk-2}List of used opterators and their meanings.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/MVPex2-1.png}
\caption{\label{fig:MVPex2}Cumulative daily returns of IBM (IBM), Apple (AAPL) and Google (GOOG)}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/MVPex5-1.png}
\caption{\label{fig:MVPex5}Optimal MVP for each lambda and interpolated efficiency frontier}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/MVPex6-1.png}
\caption{\label{fig:MVPex6}Portfolio composition regarding each lambda}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-4}Comparison of the use of the arithmetic and geometric means in calculating MVPs for each lambda. Plot of MVPs in terms of mu - sigma calculated using only the arithmetic mean.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/ITPex-1.png}
\caption{\label{fig:ITPex}Comparison of ITP-TEV and ITP-MSTE objectives, presented as cumulative daily returns.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/qpmvp4-1.png}
\caption{\label{fig:qpmvp4}Comparison of efficiency frontiers generated from an ascending pool of assets, starting with the asset with the lowest variance and sequentially adding the asset with the next lowest variance to the pool. Displayed in a mu - sigma diagramm.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/qpitp4-1.png}
\caption{\label{fig:qpitp4}Standard deviation (sd) between the performance of the SP500TR and the tracking portfolio over the fitting period for each asset pool of size N. The asset pool was created successively by discarding the five assets with the lowest weights to create the next pool.}
\end{figure}
...
\texttt{\{=latex,\ fig.cap="Visualization\ of\ the\ behavior\ of\ the\ standard\ PSO\ in\ a\ GIF."\}\ \textbackslash{}begin\{center\}\ \textbackslash{}animategraphics{[}loop,\ width=10cm{]}\{10\}\{./gifs/pso\_2dim/gganim\_plot\}\{1\}\{80\}\ \textbackslash{}end\{center\}}
...
\caption{\label{fig:pso7}Comparison of the MVP's generated with solve.QP() and the PSO. The gray lines show the difference of the solutions of both approaches for each lambda.}
\end{figure}
...
\caption{\label{fig:pso8}Comparison of solving ITP-MSTE with solve.QP() and the PSO.}
\end{figure}
...
\caption{\label{fig:pso9}Comparison of solving dicrete ITP-MSTE with solve.QP() with rounding and the PSO.}
\end{figure}
...
\caption{\label{fig:variants1}Fitness: Benchmark solution with the standard PSO for comparison with the created variants.}
\end{figure}
...
\caption{\label{fig:variants2}Statistics: Benchmark solution with the standard PSO for comparison with the created variants.}
\end{figure}

\hypertarget{function-stretching}{%
\section{Function Stretching}\label{function-stretching}}

PSO often becomes stuck in local minima, that is, if the current best global position is a local minimum with a larger environment around it, with only higher fitness. In such situations, it is difficult for the PSO to escape to find the global minimum. Function stretching attempts to allow the PSO to escape from such local minima by transforming the fitness function in the manner described in \citep{PaVr2002}. After finding a local minimum, a two-stage transformation proposed by Vrahatis in 1996 can be used to stretch the original function such that the discovered local minimum is transformed into a maximum, but any position with less fitness remains unchanged. The two stages of the transformation with a discovered local minimum \(\bar{x}\) are:
\begin{equation} 
...
\caption{\label{fig:variants3}Comparison of fitness between the PSO with functional stretching and the standard PSO.}
\end{figure}
...
\caption{\label{fig:variants4}Comparison of statistics between the PSO with functional stretching and the standard PSO.}
\end{figure}
...
\caption{\label{fig:variants5}Comparison of fitness between the local PSO and the standard PSO.}
\end{figure}
...
\caption{\label{fig:variants6}Comparison of statistics between the local PSO and the standard PSO.}
\end{figure}
...
\begin{verbatim}
[1] "Elapsed time: 186.18 seconds"
\end{verbatim}

It can be seen that after a million randomly generated positions, there was not a single feasible position. For this reason, the first step has been modified to start with only one feasible position, randomly selected from one of the final solutions of the standard PSO. To allow comparison with the standard PSO, the procedure was run again with the same starting positions.
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/variants6next-1.png}
\caption{\label{fig:variants6next}Comparison of fitness between the PSO with feasibility preservation and the standard PSO, starting from the same randomly selected initial particles obtained from the last iterations of the standard PSO benchmark solutions.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/variants6next2-1.png}
\caption{\label{fig:variants6next2}Comparison of statistics between the PSO with feasibility preservation and the standard PSO, starting from the same randomly selected initial particles obtained from the last iterations of the standard PSO benchmark solutions.}
\end{figure}
...
\item
  Repeat\\
  Steps 2 to 5 are repeated until the maximum iteration \(i_{max}\) is reached.
\end{enumerate}
...
\caption{\label{fig:unnamed-chunk-12}Comparison of the different distributions used in the velocity update of the PSO with self-adapting velocity depending on the iteration.}
\end{figure}
...
\caption{\label{fig:variants7}Comparison of fitness between the PSO with self-adaptive velocity and the standard PSO.}
\end{figure}
...
\caption{\label{fig:variants8}Comparison of statistics between the PSO with self-adaptive velocity and the standard PSO.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/variantspkg-1.png}
\caption{\label{fig:variantspkg}Comparison of fitness between the PSO R-package with standard PSO settings and the standard PSO.}
\end{figure}
...
\caption{\label{fig:variants9}Comparison of statistics between the PSO R-package with standard PSO settings and the standard PSO.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/93-1.png}
\caption{\label{fig:93}Comparison of the cumulative daily returns of the backtests with the transaction cost value k=0}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/94-1.png}
\caption{\label{fig:94}Comparison of the statistics of the backtests with the transaction cost value k=0}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/95-1.png}
\caption{\label{fig:95}Comparison of the cumulative daily returns of the backtests with the transaction cost value k=10}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/96-1.png}
\caption{\label{fig:96}Comparison of the statistics of the backtests with the transaction cost value k=10}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/97-1.png}
\caption{\label{fig:97}Comparison of the cumulative daily returns of the backtests with the transaction cost value k=20}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/98-1.png}
\caption{\label{fig:98}Comparison of the statistics of the backtests with the transaction cost value k=20}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/99-1.png}
\caption{\label{fig:99}Comparison of the cumulative daily returns of the backtests with the transaction cost value k=30}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Master_Thesis_files/figure-latex/910-1.png}
\caption{\label{fig:910}Comparison of the statistics of the backtests with the transaction cost value k=30}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-13}Cumulative daily return loss of the discrete PSO backtests due to transaction costs with respect to the different values of k.}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-14}Comparison of cumulative daily returns of the continuous backtest performed with solve.QP() and the SP500TR.}
\end{figure}
