...
\begin{verbatim}
## [1] "mean P_fit: 12.5166184572097"
## [1] "P_g_fit: 5.99668689747084"
## [1] "mean P_fit: 11.9838464195393"
## [1] "P_g_fit: 5.99668689747084"
## [1] "mean P_fit: 11.9838464195393"
## [1] "P_g_fit: 5.99668689747084"
## [1] "mean P_fit: 11.5117064683784"
## [1] "P_g_fit: 5.99668689747084"
## [1] "mean P_fit: 8.21671445243426"
## [1] "P_g_fit: 5.00470585492461"
## [1] "mean P_fit: 5.11812357142387"
## [1] "P_g_fit: 1.4212891729448"
## [1] "mean P_fit: 5.11812357142387"
## [1] "P_g_fit: 1.4212891729448"
## [1] "mean P_fit: 4.73602496770644"
## [1] "P_g_fit: 1.4212891729448"
## [1] "mean P_fit: 3.97953677453534"
## [1] "P_g_fit: 1.35364088410123"
## [1] "mean P_fit: 3.45035408999126"
## [1] "P_g_fit: 1.11433044261825"
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{grid }\OtherTok{\textless{}{-}} \FunctionTok{expand.grid}\NormalTok{(}\FunctionTok{seq}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{, }\AttributeTok{length.out =} \DecValTok{100}\NormalTok{), }\FunctionTok{seq}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{, }\AttributeTok{length.out =} \DecValTok{100}\NormalTok{), }\AttributeTok{stringsAsFactors =}\NormalTok{ F)}
\NormalTok{grid}\SpecialCharTok{$}\NormalTok{z }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(grid, }\DecValTok{1}\NormalTok{, fn)}

\FunctionTok{library}\NormalTok{(ggplot2)}
\FunctionTok{library}\NormalTok{(gganimate)}
\FunctionTok{library}\NormalTok{(metR)}
\DocumentationTok{\#\#\#library(magick)}
\CommentTok{\# install.packages(\textquotesingle{}tinytex\textquotesingle{})}
\CommentTok{\# tinytex::install\_tinytex()}

\NormalTok{anim }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(trace\_data) }\SpecialCharTok{+}
  \FunctionTok{geom\_contour}\NormalTok{(}\AttributeTok{data =}\NormalTok{ grid, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Var1, }\AttributeTok{y =}\NormalTok{ Var2, }\AttributeTok{z =}\NormalTok{ z), }\AttributeTok{color =} \StringTok{"black"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(X1, X2)) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"X"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Y"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{transition\_time}\NormalTok{(iter) }\SpecialCharTok{+}
  \FunctionTok{ease\_aes}\NormalTok{(}\StringTok{"linear"}\NormalTok{)}


\ControlFlowTok{if}\NormalTok{(}\SpecialCharTok{!}\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{is\_latex\_output}\NormalTok{())\{}
\NormalTok{  anim}
  \FunctionTok{animate}\NormalTok{(anim, }\AttributeTok{renderer =} \FunctionTok{file\_renderer}\NormalTok{(}\StringTok{\textquotesingle{}gifs/pso\_2dim/\textquotesingle{}}\NormalTok{), }\AttributeTok{device =} \StringTok{"jpeg"}\NormalTok{)}
\NormalTok{\}}
\CommentTok{\# else\{}
\CommentTok{\#   animate(anim, renderer = file\_renderer(\textquotesingle{}gifs/pso\_2dim/\textquotesingle{}))}
\CommentTok{\# \}}

\CommentTok{\# anim\_save(path="gifs/", filename = "pso\_2dim.gif", animation = anim)}
\CommentTok{\# gif\_file("gifs/pso\_2dim.gif")}

\CommentTok{\# \#psoptim()}
\CommentTok{\# }
\CommentTok{\# pso\_default \textless{}{-} function(}
\CommentTok{\#   par,}
\CommentTok{\#   fn,}
\CommentTok{\#   ...,}
\CommentTok{\#   lower,}
...
\hypertarget{example-2-dimensions}{%
\section{Example: 2-Dimensions}\label{example-2-dimensions}}
