...
\]
and with a rebalancing constraint of \(30%
\) (\(0.3\)), the rebalanced portfolio is feasible if:
\[
  w^{rb} \leq 0.3
\]
...
The following charts visualize the test period of the whole backtests. The \texttt{QP} line is continuous and represents the optimal solution using the ITP MSTE approach. The discretized solution using the PSO is named \texttt{PSO} and the \texttt{PSO\_TE} considers all transaction costs. Everything is compared to the SP500TR which is the objective to track. Furthermore there are used different values for the transaction costs intensity \(k\) of each backtest:

\includegraphics{Master_Thesis_files/figure-latex/9_2-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p\_0tc }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{html\_save}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{MSTE\_infos\_0tc }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(type) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise}\NormalTok{(}
    \AttributeTok{fit=}\FunctionTok{mean}\NormalTok{(fittness),}
    \AttributeTok{const\_break =} \FunctionTok{mean}\NormalTok{(const\_break),}
    \AttributeTok{rebalance\_constraint =} \FunctionTok{mean}\NormalTok{(rebalance\_constraint),}
    \AttributeTok{transaction\_cost\_constraint =} \FunctionTok{mean}\NormalTok{(transaction\_cost\_constraint),}
    \AttributeTok{sum\_wgt =} \FunctionTok{mean}\NormalTok{(sum\_wgt),}
    \AttributeTok{n\_assets =} \FunctionTok{mean}\NormalTok{(n\_assets),}
    \AttributeTok{transaction\_costs =} \FunctionTok{mean}\NormalTok{(transaction\_costs)}
\NormalTok{  ) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{calc\_type =} \StringTok{"mean"}
\NormalTok{  ) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{select}\NormalTok{(calc\_type, }\FunctionTok{everything}\NormalTok{()) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{select}\NormalTok{(}\SpecialCharTok{{-}}\FunctionTok{c}\NormalTok{(}\StringTok{"type"}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{reactable}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p\_10tc }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{html\_save}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{MSTE\_infos\_10tc }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(type) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise}\NormalTok{(}
    \AttributeTok{fit=}\FunctionTok{mean}\NormalTok{(fittness),}
    \AttributeTok{const\_break =} \FunctionTok{mean}\NormalTok{(const\_break),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p\_20tc }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{html\_save}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{MSTE\_infos\_20tc }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(type) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise}\NormalTok{(}
    \AttributeTok{fit=}\FunctionTok{mean}\NormalTok{(fittness),}
    \AttributeTok{const\_break =} \FunctionTok{mean}\NormalTok{(const\_break),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p\_30tc }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{html\_save}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{MSTE\_infos\_30tc }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(type) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise}\NormalTok{(}
    \AttributeTok{fit=}\FunctionTok{mean}\NormalTok{(fittness),}
    \AttributeTok{const\_break =} \FunctionTok{mean}\NormalTok{(const\_break),}
