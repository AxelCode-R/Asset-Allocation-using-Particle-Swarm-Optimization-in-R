...
It can be seen that the analytical approach and the PSO approach have a tiny difference for \(lambda > 0.8\) and a steadily increansed diffrence otherwise. This indicates that minimum variance portfolios are more stable to generate with the PSO.
...
\NormalTok{itp\_QP }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(pool\_returns, bm\_returns)\{}
...
\NormalTok{  res }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}
    \StringTok{"value"} \OtherTok{=}\NormalTok{ qp}\SpecialCharTok{$}\NormalTok{value,}
    \StringTok{"var"} \OtherTok{=} \FunctionTok{as.numeric}\NormalTok{(}
      \FunctionTok{var}\NormalTok{(pool\_returns }\SpecialCharTok{\%*\%}\NormalTok{ qp}\SpecialCharTok{$}\NormalTok{solution }\SpecialCharTok{{-}}\NormalTok{ bm\_returns)),}
    \StringTok{"solution"} \OtherTok{=} \FunctionTok{setNames}\NormalTok{(qp}\SpecialCharTok{$}\NormalTok{solution, }\FunctionTok{colnames}\NormalTok{(pool\_returns))}
\NormalTok{  )}
...
\NormalTok{itp\_PSO }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(pool\_returns, bm\_returns, }\AttributeTok{silent =}\NormalTok{ T)\{}
\NormalTok{  mat }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}
    \AttributeTok{Dmat =} \FunctionTok{cov}\NormalTok{(pool\_returns),}
    \AttributeTok{dvec =} \FunctionTok{cov}\NormalTok{(pool\_returns, bm\_returns),}
    \AttributeTok{Amat =} \FunctionTok{t}\NormalTok{(}\FunctionTok{rbind}\NormalTok{(}
...
\NormalTok{  calc\_fit }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(x)\{}
    \FunctionTok{as.numeric}\NormalTok{(}\FloatTok{0.5} \SpecialCharTok{*} \FunctionTok{t}\NormalTok{(x) }\SpecialCharTok{\%*\%}\NormalTok{ mat}\SpecialCharTok{$}\NormalTok{Dmat }\SpecialCharTok{\%*\%}\NormalTok{ x }\SpecialCharTok{{-}} \FunctionTok{t}\NormalTok{(mat}\SpecialCharTok{$}\NormalTok{dvec) }\SpecialCharTok{\%*\%}\NormalTok{ x)}
\NormalTok{  \}}
...
\NormalTok{    const[mat}\SpecialCharTok{$}\NormalTok{meq] }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\FunctionTok{abs}\NormalTok{(const[mat}\SpecialCharTok{$}\NormalTok{meq])}
    \SpecialCharTok{{-}}\FunctionTok{min}\NormalTok{(}\DecValTok{0}\NormalTok{, const)}
\NormalTok{  \}}
\NormalTok{  pso\_res }\OtherTok{\textless{}{-}} \FunctionTok{pso}\NormalTok{(}
    \AttributeTok{par =} \FunctionTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FunctionTok{ncol}\NormalTok{(pool\_returns)),}
...
\NormalTok{    \},}
    ...
    \AttributeTok{upper =} \FloatTok{0.1}\NormalTok{,}
    \AttributeTok{control =} \FunctionTok{list}\NormalTok{(}
      \AttributeTok{s =} \DecValTok{100}\NormalTok{, }\CommentTok{\# swarm size}
      \AttributeTok{c.p =} \FloatTok{0.5}\NormalTok{, }\CommentTok{\# inherit best}
      \AttributeTok{c.g =} \FloatTok{0.5}\NormalTok{, }\CommentTok{\# global best}
      \AttributeTok{maxiter =} \DecValTok{100}\NormalTok{, }\CommentTok{\# iterations}
      \AttributeTok{w0 =} \FloatTok{0.9}\NormalTok{, }\CommentTok{\# starting inertia weight}
      \AttributeTok{wN =} \DecValTok{0}\NormalTok{, }\CommentTok{\# ending inertia weight}
      \AttributeTok{save\_traces =}\NormalTok{ F }\CommentTok{\# save more information}
\NormalTok{    )}
\NormalTok{  )}
  \ControlFlowTok{if}\NormalTok{(}\SpecialCharTok{!}\NormalTok{silent)\{}
    \FunctionTok{p0}\NormalTok{(}\StringTok{"constraint: "}\NormalTok{, }\FunctionTok{sum}\NormalTok{(}\FunctionTok{calc\_const}\NormalTok{(pso\_res}\SpecialCharTok{$}\NormalTok{solution)))}
    \FunctionTok{p0}\NormalTok{(}\StringTok{"fitness: "}\NormalTok{, }\FunctionTok{calc\_fit}\NormalTok{(pso\_res}\SpecialCharTok{$}\NormalTok{solution))}
\NormalTok{  \}}
  
\NormalTok{  res }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}
    \StringTok{"composition"} \OtherTok{=} \FunctionTok{setNames}\NormalTok{(pso\_res}\SpecialCharTok{$}\NormalTok{solution, }\FunctionTok{colnames}\NormalTok{(pool\_returns)),}
    \StringTok{"fit"} \OtherTok{=} \FunctionTok{calc\_fit}\NormalTok{(pso\_res}\SpecialCharTok{$}\NormalTok{solution),}
    \StringTok{"constraint"} \OtherTok{=} \FunctionTok{calc\_const}\NormalTok{(pso\_res}\SpecialCharTok{$}\NormalTok{solution),}
    \StringTok{"var"} \OtherTok{=} \FunctionTok{as.numeric}\NormalTok{(}
      \FunctionTok{var}\NormalTok{(pool\_returns }\SpecialCharTok{\%*\%}\NormalTok{ pso\_res}\SpecialCharTok{$}\NormalTok{solution }\SpecialCharTok{{-}}\NormalTok{ bm\_returns))}
\NormalTok{  )}
...
\NormalTok{  temp\_qp }\OtherTok{\textless{}{-}} \FunctionTok{itp\_QP}\NormalTok{(pool\_returns\_raw, bm\_returns)}
\NormalTok{)}
\NormalTok{df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"type"}\OtherTok{=}\StringTok{"ITP\_QP"}\NormalTok{, }\StringTok{"var"}\OtherTok{=}\NormalTok{temp\_qp}\SpecialCharTok{$}\NormalTok{var, }\StringTok{"fitness"}\OtherTok{=}\NormalTok{temp\_qp}\SpecialCharTok{$}\NormalTok{value, }\StringTok{"constraint"}\OtherTok{=}\DecValTok{0}\NormalTok{, }\StringTok{"time"}\OtherTok{=}\NormalTok{time[}\DecValTok{3}\NormalTok{])}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\DecValTok{10}\NormalTok{)\{}
\NormalTok{  time }\OtherTok{\textless{}{-}} \FunctionTok{system.time}\NormalTok{(}
\NormalTok{    temp\_pso }\OtherTok{\textless{}{-}} \FunctionTok{itp\_PSO}\NormalTok{(pool\_returns\_raw, bm\_returns)}
\NormalTok{  )}
\NormalTok{  df }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(}
\NormalTok{    df, }
    \FunctionTok{data.frame}\NormalTok{(}
      \StringTok{"type"}\OtherTok{=}\StringTok{"ITP\_PSO"}\NormalTok{, }
      \StringTok{"var"}\OtherTok{=}\NormalTok{temp\_pso}\SpecialCharTok{$}\NormalTok{var, }
      \StringTok{"fitness"}\OtherTok{=}\NormalTok{temp\_pso}\SpecialCharTok{$}\NormalTok{fit, }
      \StringTok{"constraint"}\OtherTok{=}\NormalTok{temp\_pso}\SpecialCharTok{$}\NormalTok{constraint, }
      \StringTok{"time"}\OtherTok{=}\NormalTok{time[}\DecValTok{3}\NormalTok{]}
\NormalTok{    )}
\NormalTok{  )}
\NormalTok{\}}
\NormalTok{df}\SpecialCharTok{$}\NormalTok{sd }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{var)}

\NormalTok{df\_summary }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(}
\NormalTok{  df }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(type }\SpecialCharTok{==} \StringTok{"ITP\_QP"}\NormalTok{),}
\NormalTok{  df }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(type }\SpecialCharTok{==} \StringTok{"ITP\_PSO"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(fitness }\SpecialCharTok{==} \FunctionTok{min}\NormalTok{(fitness)) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{type =} \StringTok{"ITP\_PSO\_best"}\NormalTok{),}
\NormalTok{  df }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(type }\SpecialCharTok{==} \StringTok{"ITP\_PSO"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{group\_by}\NormalTok{(type) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{summarise\_all}\NormalTok{(., mean) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{type =} \StringTok{"ITP\_PSO\_mean"}\NormalTok{)}
\NormalTok{)}
\FunctionTok{rownames}\NormalTok{(df\_summary) }\OtherTok{\textless{}{-}} \ConstantTok{NULL}
\NormalTok{df\_summary}\SpecialCharTok{$}\NormalTok{var }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(df\_summary}\SpecialCharTok{$}\NormalTok{var, }\DecValTok{7}\NormalTok{)}
\NormalTok{df\_summary}\SpecialCharTok{$}\NormalTok{sd }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(df\_summary}\SpecialCharTok{$}\NormalTok{sd, }\DecValTok{4}\NormalTok{)}
\NormalTok{df\_summary}\SpecialCharTok{$}\NormalTok{fitness }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(df\_summary}\SpecialCharTok{$}\NormalTok{fitness, }\DecValTok{7}\NormalTok{)}
\NormalTok{df\_summary}\SpecialCharTok{$}\NormalTok{constraint }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(df\_summary}\SpecialCharTok{$}\NormalTok{constraint, }\DecValTok{18}\NormalTok{)}
\NormalTok{df\_summary}\SpecialCharTok{$}\NormalTok{time }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(df\_summary}\SpecialCharTok{$}\NormalTok{time, }\DecValTok{1}\NormalTok{)}

\FunctionTok{reactable}\NormalTok{(df\_summary) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{html\_save}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
